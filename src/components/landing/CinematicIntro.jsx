...
const DESCENT_MS     = 720   // wordmark Y travel — 15% faster than 850
const SETTLE_MS      = 320   // scale settle after impact
const DRIFT_WAIT     = 580   // how long burst holds before drift
const ASSEMBLE_WAIT  = 650   // gap before tagline assembles
const SUB_WAIT       = 220   // gap before sub-tagline
const CTA_WAIT       = 580   // gap before CTA
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      t(DESCENT_MS, () => {
        ...
        // 2. Scale settle on wordmark — simultaneous with burst
        wordmarkCtrl.start({
          scale: [1.0, 0.96, 1.0],
          transition: {
